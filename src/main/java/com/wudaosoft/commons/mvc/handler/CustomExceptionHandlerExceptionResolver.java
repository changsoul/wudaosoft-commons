...
public class CustomExceptionHandlerExceptionResolver extends
	...
	private static final Logger logger = LoggerFactory.getLogger(CustomExceptionHandlerExceptionResolver.class);
	
	private static final String DEFAULT_EXCEPTION_ATTRIBUTE = "exception";
	
	private static final String DEFAULT_ERROR_STRING = "{\"errCode\":-1,\"errMsg\":\"System error\"}";
	private static final String NOT_FOUND_STRING = "{\"errCode\":404,\"errMsg\":\"Not found\"}";
	...
	protected ModelAndView handleResponseBody(HttpServletRequest request, HttpServletResponse response,
		...
		String value = DEFAULT_ERROR_STRING;
		...
		if (exception instanceof ServiceException) {
			...
			value = new ParameterException().toJsonString();
	...
	private String getI18nValue(String lang, ServiceException ex) {

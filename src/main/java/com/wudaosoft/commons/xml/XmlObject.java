...
public class XmlObject {
	 ...
	 */
	public String build() {
		StringBuilder xml = new StringBuilder("<?xml version=\"1.0\" encoding=\"UTF-8\"?><xml>");
	...
	public String build(String rootTag) {
		StringBuilder xml = new StringBuilder("<?xml version=\"1.0\" encoding=\"UTF-8\"?><").append(rootTag).append(">");
	...
	public <T> T buildBean(Class<T> destClazz, boolean isFirstUpperCase) {

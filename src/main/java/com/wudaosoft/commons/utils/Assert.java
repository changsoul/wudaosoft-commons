...
public abstract class Assert {
	...
	protected static final int PARAM_CODE = 100;
	
	/**
	 * Assert a boolean expression, throwing {@code ServiceException}
	...
	public static void isTrue(boolean expression, String message) {
		if (!expression) {
			throw new ServiceException(PARAM_CODE, message);
		}
	}
	...
	public static void isAssignable(Class<?> superType, Class<?> subType, String message) {
		...
		if (subType == null || !superType.isAssignableFrom(subType)) {
			throw new ServiceException((StringUtils.hasLength(message) ? message + " " : "") +
	...
	/**
	 * Assert a boolean expression, throwing {@link ServiceException}
	 * if the test result is {@code false}.
	 * <p>Call {@link #isTrue(boolean)} if you wish to
	 * throw {@link ServiceException} on an assertion failure.
	 * <pre class="code">Assert.state(id == null);</pre>
	 * @param expression a boolean expression
	 * @throws ServiceException if the supplied expression is {@code false}
	 */
